        ...
        <div class="flex flex-col justify-center items-center px-6 mx-auto h-screen xl:px-0 dark:bg-gray-900">
            ...
            <div class="text-center xl:max-w-4xl">
                ...
                <p class="mb-5 text-base font-normal text-gray-500 md:text-lg dark:text-gray-400">
                    Desculpe pelo inconveniente, mas estamos realizando uma manutenção no momento. Se precisar você sempre pode <a
                        href="#" class="text-blue-700 hover:underline dark:text-blue-500">entrar em contato</a>,
                        caso contrário, estaremos online novamente em breve!</p>
                <a href="{{ route('home') }}"
