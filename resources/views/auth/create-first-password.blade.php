...
<head>
    ...
    <title>LivePRO - Primeira Senha</title>
...
<body class="bg-gray-900 text-white flex items-center justify-center min-h-screen">
    <div class="flex max-w-6xl bg-gray-800 rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="w-full md:w-1/2 p-8 md:p-12">
            ...
            <form action="{{ route('create.first.password.action') }}" method="POST" class="space-y-4">
                @csrf
                <div>
                ...
                <div class="flex items-center justify-between text-sm">
                    <a href="{{ route('dashboard') }}" class="text-blue-400 hover:underline">
