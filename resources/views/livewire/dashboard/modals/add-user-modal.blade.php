        ...
        <div class="relative w-full h-full max-w-2xl px-4 md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="p-6 space-y-6">
                    <form wire:submit="save">
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="phone"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Telefone/Celular</label>
                                <div class="flex">
                                    <span
                                        class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-e-0 border-gray-300 rounded-s-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                                        <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true"
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <div class="flex">
                                    ...
                                    <select type="text" id="role" wire:model="role" required
                                        class="rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <label class="inline-flex items-center cursor-pointer mb-5">
                                    <input id="status" type="checkbox" checked class="sr-only peer" wire:model="status">
                                    <div
                ...
                <div
                    ...
                    <button data-modal-toggle="add-user-modal"
