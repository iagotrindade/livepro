...
class SupportAnsweredNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject('LivePRO - Ticket Respondido por um Agente de Suporte')
            ->greeting('Olá ' . $this->support->user->name . '!')
            ->line('Informamos que sua solicitação foi respondida por um de nossos Agentes de Suporte LivePRO!')
            ->line('Para visualizar a resposta, acesse o ticket clicando no botão abaixo.')
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'title' => 'Ticket respondido por um agente de suporte',
