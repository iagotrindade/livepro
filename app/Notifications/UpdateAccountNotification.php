...
class UpdateAccountNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject('LivePRO - Alteração de dados da sua conta')
            ->greeting('Olá ' . $this->userName . '!')
            ->line('Nós detectamos alterações nos dados da sua conta no LivePRO!')
            ->line('Caso não seja você que tenha feito essas alterações, recomendamos alterar imediatamente sua senha de acesso')
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'title' => 'Alteração de dados da sua conta',

            'body' => 'Foram realizadas alterações nos dados da sua conta. Caso não seja você que tenha feito essas alterações, recomendamos alterar imediatamente sua senha de acesso',
        ];
    }
}
